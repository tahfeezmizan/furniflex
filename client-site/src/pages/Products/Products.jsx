...
const Products = () => {
    ...
    const itemPerPage = 6;
    const numberOfPages = Math.ceil(count / itemPerPage); // Total pages
    const [currentPage, setCurrentPage] = useState(1); // Start from page 1
    const pages = [...Array(numberOfPages).keys()].map(i => i + 1); // Pages array, starting from 1

    useEffect(() => {
        // Create the API URL with pagination and category
